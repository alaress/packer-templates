...
urpmi.addmedia -q --distrib http://mirror.internode.on.net/pub/mageia/distrib/1/x86_64

# Adds default distributed mirrors
#urpmi.addmedia -q --distrib --mirrorlist '$MIRRORLIST'

# Add cyprix mirror
#urpmi.addmedia -q --distrib rsync://cyprix.com.au/rpm/Mga1
...
urpmi -q --auto kernel-desktop-devel-`uname -r|sed 's/desktop-//g'`
